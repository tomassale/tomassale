...
const securityHeaders = [
  ...
  // El sitio no usa ninguna de estas capacidades. Declararlo no cierra nada
  // explotable hoy: evita que un script que llegue a colarse mañana pueda
  // pedirlas en nombre del visitante.
  {
